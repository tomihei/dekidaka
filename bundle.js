	    ...
	    var Form = (function (_super) {
	        ...
	        Form.prototype.render = function () {
	            ...
	            if (this.props.type === "number") {
	                ...
	                num = React.createElement("select", {className: "form-control"}, React.createElement("option", {default: true}, this.props.placeholder));
	            }
	            else {
	    ...
	    var TrData = (function (_super) {
	        ...
	        TrData.prototype.render = function () {
	            ...
	            if (this.props.inputOn) {
	                input = React.createElement(form_1.Input, {inputvalue: "削除", onSubmit: this.handleClick});
	                return React.createElement("tr", null, td, React.createElement("td", null, input));
	            }
	            else {
